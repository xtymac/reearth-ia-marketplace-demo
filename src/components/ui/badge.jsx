...
const badgeVariants = {
  ...
  infobox: 'bg-[#4FA3FF] text-white border-transparent', // blue
  visualizer: 'bg-[#FF6F6F] text-white border-transparent', // visualizer red
  // Platform-specific variants for function badges
  'platform-visualizer': 'bg-[#FF6F6F] text-white border-transparent', // visualizer red
  'platform-cms': 'bg-[#6FCF97] text-white border-transparent', // green
  'platform-flow': 'bg-[#9B59B6] text-white border-transparent', // purple
};
